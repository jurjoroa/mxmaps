...
# Output: data/mxmunicipio_hex_sf_v8_5.rds (full) or /tmp/v85_states.rds.
...
if (is.null(ONLY)) {
  ...
  saveRDS(hex_v8, "data/mxmunicipio_hex_sf_v8_5.rds")
  cat(sprintf("Saved data/mxmunicipio_hex_sf_v8_5.rds (%d cells)\n", nrow(hex_v8)))
} else {
  saveRDS(hex_v8, "/tmp/v85_states.rds")
  cat(sprintf("Saved /tmp/v85_states.rds (%d cells)\n", nrow(hex_v8)))
}
